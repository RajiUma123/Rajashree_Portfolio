...
function Experience() {
  return (
    <div className='border-b border-neutral-900 pb-4'>
      <motion.h1 id='experience' 
      whileInView={{opacity: 1,x: 0}}
      initial={{opacity: 0 , x: -100}}
      transition={{duration:1}}
      className='my-20 text-center text-4xl mb-10'>Experience</motion.h1>
      <div>
        {EXPERIENCES.map((experience,index)=>(
              ...
              <p className='mb-2 text-sm text-neutral-400  text-10xl'>{experience.year}</p>
